...
1. 使用現有金鑰解密現有資料。 [了解更多資訊](https://experienceleague.adobe.com/en/docs/control-panel/using/instances-settings/gpg-keys-management#decrypting-data){target="_blank"}。
