...
* **[!UICONTROL Opens]** ：已開啟的訊息總數。 未考慮文字格式的電子郵件。 [了解更多](metrics-calculation.md#tracking-opens-)。
...
>[!NOTE]
>
>此報告中顯示的網域名稱是在多維資料庫層級定義的。 若要變更這些值，請編輯 **[!UICONTROL Delivery logs (broadlogrcp)]** 立方體。 如需詳細資訊，請參閱[本章節](gs-cubes.md)。此 **[!UICONTROL Others]** 類別包括不屬於特定類別的網域名稱。
