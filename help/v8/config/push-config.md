...
您可以使用iOS和Android的市場活動軟體開發工具包，以便將您的移動應用程式整合到Adobe Campaign平台。
...
>[!NOTE]
>
>您也可以在資料收集 UI 設定 Adobe Experience Platform 延伸功能，以便使用 Adobe Campaign Mobile SDK。[瞭解開發人員文檔中的詳細資訊](https://developer.adobe.com/client-sdks/documentation/adobe-campaign-classic){target="_blank"}。
...
* **整合密鑰**:使Adobe Campaign平台能夠識別移動應用。
   ...
   >[!NOTE]
   >
   >此整合密鑰在Adobe Campaign控制台中輸入， **[!UICONTROL Information]** 專用於移動應用程式的服務頁籤。
