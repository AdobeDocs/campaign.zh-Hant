...
屬性允許您定義構成資料對象的欄位。 您可以使用 **[!UICONTROL Insert]** 按鈕，將空屬性模板拖放到游標所在的XML中。 在[本章節](create-schema.md)了解更多資訊。

![](assets/schemaextension_2.png)

屬性的完整清單可在 `<attribute>` 元素節 [Campaign Classicv7文檔](https://experienceleague.adobe.com/docs/campaign-classic/using/configuring-campaign-classic/schema-reference/elements-attributes/attribute.html#content-model)。 以下是一些更常用的屬性： **@advanced**。 **@dataPolicy**。 **@default**。 **@desc**。 **@enum**。 **@expr**。 **@label**。 **@length**。 **@name**。 **@notNull**。 **@required**。 **@ref**。 **@xml**。 **@type**。

![](../assets/do-not-localize/book.png) 有關每個屬性的詳細資訊，請參閱中的「屬性」說明 [Campaign Classicv7文檔](https://experienceleague.adobe.com/docs/campaign-classic/using/configuring-campaign-classic/schema-reference/elements-attributes/schema-introduction.html#configuring-campaign-classic)。
