...
配置並準備發送交貨後，請確保已運行交貨分析。 [了解更多](delivery-analysis.md)
...
>[!NOTE]
>
>當前 **非同步** 通過inMail流程對回報進行限定 **[!UICONTROL Inbound email]** 規則。
...
|--- |--- |--- |
| 已成功將消息從市場活動中轉到MTA | **[!UICONTROL Success]** 百分比未顯示（以0%開始） | 服務提供者已將其列入考量 |
| 從MTA返回硬跳消息 | 未更改 **[!UICONTROL Success]** 百分比 | 失敗 |
| 從MTA返回軟跳跳消息 | 未更改 **[!UICONTROL Success]** 百分比 | 服務提供者已將其列入考量 |
