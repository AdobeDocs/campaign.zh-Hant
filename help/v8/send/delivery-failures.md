...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> 軟退回 </td> 
   <td> 5 </td> 
   <td> 此使用者的信箱已滿，無法接受更多郵件。 此輪廓將再次定位，直到錯誤計數達到5。 之後，記錄將設定為隔離狀態，不會再重試。<br /> 此型別的錯誤是由清理程式所管理，地址在30天後會設定為有效狀態。<br /> 警告：若要從隔離位址清單自動移除位址，必須啟動資料庫清理技術工作流程。<br /> </td> 
  </tr> 
  <tr> 
   <td> 未連線 </td> 
   <td> 已忽略 </td> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td> 傳送期間網路連線中斷<br /> </td> 
   <td> 失敗<br /> </td> 
   <td> 位址上的Firebase Cloud Messaging服務沒有回應： {1}<br /> </td> 
   <td> 軟式<br /> </td> 
   <td> 無法連線<br /> </td> 
   <td> 是<br /> </td> 
  </tr> 
  ...
  <tr> 
   ...
   <td> 失敗<br /> </td> 
   <td> Firebase 雲端訊息伺服器傳回了意外的錯誤代碼：{1} </td> 
   <td> </td> 
   <td> 已拒絕<br /> </td> 
   <td> 否<br /> </td> 
  </tr> 
