---
title: 建立並發佈事務性消息傳遞模板
description: 瞭解如何建立和發佈事務性消息傳遞模板
...
瞭解有關中的校樣的詳細資訊 [此部分](../send/preview-and-proof.md#proofs-send)。
