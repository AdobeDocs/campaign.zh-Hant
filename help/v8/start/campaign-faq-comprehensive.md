...
[在Campaign v8中定義對象](../audiences/gs-audiences.md) | [查詢編輯器](query-editor.md) | [目標對應](../audiences/target-mappings.md)
...
* 安全性群組→ **運運算元群組** |組織單位→ **資料夾許可權**

**Campaign Web UI更新：**

* **設定檔**→收件者 |種子地址→ **測試設定檔** |傳遞分析→ **傳遞準備**
* 列出&#x200B;**→象** |電子郵件預覽→ **模擬內容**
...
[功能矩陣](https://experienceleague.adobe.com/en/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [v7到v8轉換指南](v7-to-v8.md) | [Campaign Standard到v8的轉換](https://experienceleague.adobe.com/tw/docs/campaign-web/v8/start/acs-migration){target="_blank"}
...
[開始傳遞能力](../send/about-deliverability.md) | [控制訊息內容](../send/control-message-content.md) | [監視器傳遞能力](../send/monitoring-deliverability.md) | [SpamAssassin](../send/spamassassin.md)
...
**存取：** [Campaign v8 API檔案](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
...
* **[Campaign API](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}** — 完整API參考檔案
