...
核心功能包括目標定位、定義和個人化訊息、通訊執行及相關的營運報告。
...
1. **觸發訊息** — 您可從事件[觸發訊息](../send/transactional.md)。 交易型訊息 (訊息中心) 是專為管理觸發訊息而設計的 Campaign 模組。 [本頁面](../send/transactional.md)詳細說明了設定及傳送異動訊息的步驟
...
瞭解如何[追蹤及監視您的傳遞](../send/tracking.md)
