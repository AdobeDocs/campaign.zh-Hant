...
在[本檔案](https://experienceleague.adobe.com/docs/campaign-web/v8/campaign-web-home.html?lang=zh-Hant){target="_blank"}中進一步瞭解新的Campaign網頁使用者介面。 您也可以在Campaign網頁使用者介面檔案中瀏覽專屬的[常見問題集](https://experienceleague.adobe.com/zh-hant/docs/campaign-web/v8/start/faq){target="_blank"}。
