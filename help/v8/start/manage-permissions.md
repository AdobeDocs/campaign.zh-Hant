...
1. 按一下「**儲存**」。使用者即會新增，並顯示在「使用者」清單中。 如果您將管理員角色或產品設定檔指派給使用者，使用者會收到電子郵件通知。 使用者必須按照連結完成其設定檔。
...
1. **[!UICONTROL Offer managers]** (優惠)
   ...
   此群組中的操作員可在使用互動附加元件時建立和維護優惠方案。 [了解更多](../interaction/interaction-operators.md)。
...
* 存取資料夾操作員群組的成員資格可以透過變更資料夾的安全性設定來授予或限制資料夾的存取許可權。 [了解更多](folder-permissions.md#restrict-access-to-a-folder)。
