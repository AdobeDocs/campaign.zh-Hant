...
* **方案**：方案可讓您定義日曆期間的行銷動作：啟動、游說、忠誠度等。每個方案都包含連結至日曆的行銷活動，可提供整體檢視。
...
Adobe Campaign提供&#x200B;**分散式行銷**&#x200B;附加功能，可在中央實體（總部、行銷部門等）之間實作合作行銷活動 和地方實體（商店、地區機構等）。 此協作基於共用工作區，稱為&#x200B;**[!UICONTROL List of campaign packages]**，由中心實體設計行銷活動範本給本地實體。
