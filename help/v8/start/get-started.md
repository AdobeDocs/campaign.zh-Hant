...
??在[本小節](audiences.md)中對配置檔案管理的基本知識進行了說明。

??在[此小節](import.md)中了解如何將設定檔新增至Campaign。
...
??在[此小節](audiences.md)中深入了解分段、建立受眾和個人化。
...
??了解如何在[此區段](campaigns.md)中設計、排程及執行促銷活動。
...
??了解如何在[本小節](../config/workflows.md)中設計和執行工作流程。
...
??深入了解[本小節](reporting.md)中的報告和追蹤功能。
...
??在[本節](../connect/integration.md)了解如何與Adobe服務和解決方案整合。
...
??已熟悉Campaign Classic? 在[本頁](capability-matrix.md)中瞭解 Campaign Classic 與Campaign v8 的主要差異。
...
↗️在[Campaign Classicv7檔案](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-workspace.html?lang=zh-Hant){target=&quot;_blank&quot;}中了解如何使用Campaign工作區

↗️了解如何在[Campaign Classicv7檔案](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-ui-lists.html?lang=zh-Hant){target=&quot;_blank&quot;}中自訂清單

您也可以透過網頁存取某些功能。

??[進一步了解Campaign Web Access](../start/connect.md#web-access)。
