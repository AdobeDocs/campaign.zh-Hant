...
1. 在網頁顯示期間，指令碼評估可讓您將收件者ID傳遞至優惠方案引擎。 如果ID是複合的，則金鑰會以與進階設定相同的順序顯示，並以|分隔。
...
* **狀態**：字串型別，它指定選件的新狀態。 可能的值列在&#x200B;**nms:common**&#x200B;結構描述的&#x200B;**propositionStatus** [列舉](../config/enumerations.md)中。 例如，數字3是現成可用的，對應至&#x200B;**已接受**&#x200B;狀態。
