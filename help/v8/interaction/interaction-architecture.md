...
為了能夠支援可擴充性並在入站通道上提供全天候服務， **交互** 模組在分佈式架構中實現。 此類體系結構已與 [消息中心](../architecture/architecture.md#transac-msg-archi) 由幾個實例組成：
...
>[!NOTE]
>
>安裝軟體包時， **長** 類型欄位 **nms：命題** 表，如命題ID，成為 **int64** 的下界。 此類型的資料在 [Campaign Classicv7文檔](https://experienceleague.adobe.com/docs/campaign-classic/using/configuring-campaign-classic/schema-reference/schema-structure.html#mapping-the-types-of-adobe-campaign-dbms-data){target="_blank"}。
