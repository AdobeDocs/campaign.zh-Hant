...
[進一步瞭解](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}靜態和非靜態SOAP方法。
...
1. 儲存工作流程。
1. 測試範例：
   1. 啟動工作流程。 [了解更多資訊](start-a-workflow.md)。
   1. 開啟日誌。 [了解更多資訊](monitor-workflow-execution.md#displaying-logs)。
...
使用`DeleteCollection`方法。 [了解更多資訊](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}。
...
回圈包含本機收件者變數。 對於收件者集合中傳回的每個收件者，都會列印出收件者的電子郵件。 [深入瞭解](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}有關`logInfo`函式的資訊。
...
* 若要張貼事件，您可以使用靜態`PostEvent`方法。 [了解更多資訊](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}。
...
1. 定義查詢：
   ...
   * 使用對應結構描述上的`create`方法擷取實體，例如`xtk:workflow`結構描述。 [了解更多資訊](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}。
   * 使用`queryDef`方法發出SQL查詢。

1. 使用`ExecuteQuery`方法執行查詢。 [了解更多資訊](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}。
...
* [SOAP呼叫範例](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
* 方法：
  * [建立](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
  * [DeleteCollection](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
  * [Executequery](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
  * [PostEvent](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
  * [寫入](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
* [logInfo函式](https://experienceleague.adobe.com/zh-hant/tools/campaign-api){target="_blank"}
