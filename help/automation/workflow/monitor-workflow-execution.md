...
系統不會自動清除工作流程歷史記錄：所有訊息都會依預設保留。 您可以透過以下方式清除歷史記錄 **[!UICONTROL File > Actions]** 功能表或按一下 **[!UICONTROL Actions]** 按鈕的位置。 選取 **[!UICONTROL Purge history]**。中可用的選項 **[!UICONTROL Actions]** 功能表的詳細說明，請參見 [動作工具列](start-a-workflow.md) 區段。
