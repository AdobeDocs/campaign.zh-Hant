...
* 在建立工作流程時，每個分支僅使用一個&#x200B;**[!UICONTROL Scheduler]**&#x200B;活動。 如果工作流程的同一分支有多個排程器（相互連結），則要執行的任務數量將呈指數倍增，這將使得資料庫大幅超載。 此規則也適用於所有具有&#x200B;**[!UICONTROL Scheduling & History]**&#x200B;索引標籤的活動。 深入瞭解[排程](scheduler.md)。
